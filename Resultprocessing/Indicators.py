...
def Calculation_LCOH(df):
    CRF=0.07822671821
    df['wind_capex']=df['wind_capacity']*2126.6*CRF/df['production_amount']
    df['pv_capex']=df['pv_capacity']*(1068.2)*CRF/df['production_amount']
    ...
    df['electrolyser_capex']=df['electrolyser_capacity']*(1343)*CRF/df['production_amount']
